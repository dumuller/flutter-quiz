...
class AwnserWidget extends StatelessWidget {
  ...
  AwnserWidget({this.title, this.isRight = false, this.isSelected = false});

  // Color get _selectedColorRight => isRight ? AppColors.darkGreen : AppColors.darkRed;

  // Color get _selectedColorBorderRight => isRight ? AppColors.lightGreen : AppColors.lightRed;

  // Color get _selectedColorCardRight => isRight ? AppColors.lightGreen : AppColors.lightRed;

  // Color get _selectedColorBorderCardRight => isRight ? AppColors.green : AppColors.red;
